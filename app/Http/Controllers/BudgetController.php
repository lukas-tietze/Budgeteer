...
class BudgetController extends Controller
{
    ...
    public function edit(string $slug)
    {
        ...
        $budgetCategories = Budget::all()->toArray();
    ...
    private function createUniqueSlug(string $name)
    {
        ...
        $existing = Budget::whereRaw("slug LIKE '{$slug}%'")
          ->addSelect('slug')
          ->get()
          ->toArray();
